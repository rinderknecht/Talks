...
\begin{slide}
  ...
  \begin{itemize}
    ...
    \item We joined our efforts in 2019 and met in the middle to
      produce what became LIGO.

    \item I contributed the design and the front-end, he did the
      type-checker and code generator ---~50\%-50\% in terms of lines
      of code (LOCs).
...
\begin{slide}
  ...
  \begin{itemize}
    ...
    \item \JsLIGO{} started also as a subset but evolved and became
      syntactically incompatible with its model, \TypeScript{}. For
      example, I implemented a proposal for pattern matching in
      \TypeScript{}.
    ...
    \item The front-end is made, in order, of a preprocessor, a lexer,
      ...
      executable for testing prefixes of the pipeline.
...
\begin{slide}
  ...
  \begin{itemize}
    ...
    \item The LIGO pipeline is more than a compiler, because it
      ...
      Pottier's amazing combinator\hyp{}based library \textsf{PPrint}.
...
\begin{slide}
  ...
  \begin{itemize}
    ...
    \item The LIGO tooling (LSP, pretty\hyp{}printer, decompiler etc.)
      is custom\hyp{}made.
