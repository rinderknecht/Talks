...
\title{Une formalisation d'ASN.1\\
...
\begin{frame}
\frametitle{Communication, hétérogénéité et ASN.1}
...
\begin{frame}[fragile]
\frametitle{Fragments d'ASN.1 (continué)}
...
\begin{frame}
\frametitle{ASN.1 et la chaîne de compilation}
...
\begin{frame}[fragile]
\frametitle{Incomplétudes de la norme}
...
\begin{frame}
\frametitle{Pourquoi formaliser ASN.1}
...
\begin{frame}
\frametitle{Avantages de la formalisation}
...
\begin{enumerate}
  ...
  \item Pour les comités de normalisation
    ...
    \begin{enumerate}
      ...
      \item Recherche d'incomplétudes, d'ambigüités, d'incohérences et
        de restrictions inutiles.

      \item Si un codage est formalisé aussi, des preuves de
        propriétés (ex. correction) sont envisageables.

    \end{enumerate}

  \item Pour les spécifieurs \bigskip \\
    La formalisation peut aussi définir les algorithmes
    de la phase d'analyse d'un compilateur \mbox{ASN.1}.
...
\frametitle{Objectif}
\begin{center}
\includegraphics[scale=0.5]{schema2.eps}
\end{center}
\end{frame}
...
\begin{frame}
\frametitle{Nouvel objectif}
\begin{center}
\includegraphics[scale=0.5]{schema6.eps}
\end{center}
\end{frame}
...
\begin{frame}
\frametitle{Nouvel objectif équivalent}
\begin{center}
\includegraphics[scale=0.5]{schema7.eps}
\end{center}
\end{frame}


\begin{frame}
\frametitle{Précisément}
...
\begin{frame}
\frametitle{Précisément (continué)}

\noindent Nous voulons alors prouver la {\em correction du codage
  BER}:
...
\begin{frame}[fragile]
\frametitle{Unicité du contrôle des types et du codage}
...
\begin{frame}[fragile]
\frametitle{Unicité du décodage}
...
\begin{frame}
\frametitle{\textsf{Asno}: Un nouvel outil}
...
\begin{frame}
\frametitle{Utilisations d'\textsf{Asno}}
